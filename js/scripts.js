$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Michal & Alice - Svatba",

            // Event start date
            start: new Date('Sep 07, 2024 13:00'),
            ...
            end: new Date('Sep 08, 2024 12:00'),

            // Event Address
            address: 'Hotel Lotrinský, Dlouhá 1177/69, 691 06 Velké Pavlovice',
...
// Google map
function initMap() {
    var location = {lat: 48.898415, lng: 16.816932};
...
function initBBSRMap() {
    var la_fiesta = {lat: 48.898415, lng: 16.816932};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
